...
__path = process.cwd()
     ...
     async function darkjokes(req, res) {
         ...
         let waif = (await axios.get(`https://raw.githubusercontent.com/Dafatrizaa/Database/main/darkjokes.json`)).data
         ...
         limitAdd(apikey);
         await fs.writeFileSync(__path +'/tmp/darkjokes.png', data)
         await res.sendFile(__path +'/tmp/darkjokes.png')
     }
