...
app.get('/docs', isAuthenticated, async (req, res) => { 
  ...
  let { apikey, username, email, premium, limit, totalreq } = req.user
  res.render('docs', {
    username: username,
    apikey: apikey,
    email,
...
app.get('/list/downloader', isAuthenticated, async (req, res) => { 
...
app.get('/list/searching', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
...
app.get('/list/randomimage', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
...
app.get('/list/animanga', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('animanga', {
    username: username,
    apikey: apikey,
...
app.get('/list/stalking', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('stalking', {
    username: username,
    apikey: apikey,
...
app.get('/list/creator', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('creator', {
    username: username,
    apikey: apikey,
...
app.get('/list/entertainment', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
...
app.get('/list/primbon', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('primbon', {
    username: username,
    apikey: apikey,
...
app.get('/list/other', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('other', {
    username: username,
    apikey: apikey,
...
app.get('/list/textpro', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('textpro', {
    username: username,
    apikey: apikey,
...
app.get('/list/oxy', isAuthenticated, async (req, res) => { 
  let { apikey, username, email } = req.user
  res.render('photooxy', {
    username: username,
    apikey: apikey,
