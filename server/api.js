...
const fs = require('fs')
const zrapi = require('@phaticusthiccy/open-apis')
const { download_Url } = require('../lib/scraper')

__path = process.cwd()

const { cekKey, checkLimit, limitAdd, isLimit } = require('../database/db')
...
const { darkjokes, husbu, loli, milf, cosplay, randomimage, waifu, neko, shinobu, megumin, bully, cuddle, cry, hug, awoo, kiss, lick, slap } = require('../features/randomimage')
...
const { idepep, idml, ghstalk, igstalk, wattpad, npminfo } = require('../features/stalking')
...
const { tebakgambar, asahotak, susunkata, siapakahaku, tebakkata, tebakkalimat, tebaktebakan, tekateki, tebakbendera, tebakkimia, caklontong, tebaklirik, family100, tebakkabupaten, truthdare, tebaklagu, dadu } = require('../features/entertainment')
...
const { glitchtiktok, neonlight, Style1917, deepsea3d, scifi3d, rainbow3d, waterpipe3d, stone3d, neonlight3d, gradient3d, abstragold, americanflag, spookyhallowen, bagel, berry, biscuit, blackmetal, blackpink, greenneon, neon, foggy, NeonDevil, ChristmasHoliday, Engraved3D, Space3D, Minion3D, Firework } = require('../features/textprome')
const { flamingfire, shadow, cup, cup2, romance, smoke, burnpaper, lovemessage, undergrass, love, coffe, woodheart, woodenboard, summer3d, wolfmetal, nature3d, underwater, goldenrose, summernature, fallleaves, harrypotter, carvedwood, tiktokoxy, arcade8bit, battlefield4, pubg, bannergraffiti } = require('../features/oxy')
const { glass } = require('../features/ephoto360')
     ...
     //Random Image
     router.get('/randomimage/darkjokes', darkjokes)
     ...
     // Stalking
     router.get('/stalkff', idepep)
     router.get('/stalkml', idml)
     ...
     router.get('/textpro/1917style', Style1917)
     router.get('/textpro/3ddeepsea', deepsea3d)
     router.get('/textpro/3dscifi', scifi3d)
     router.get('/textpro/3drainbow', rainbow3d)
     router.get('/textpro/3dwaterpipe', waterpipe3d)
     router.get('/textpro/3dstone', stone3d)
     router.get('/textpro/3dneonlight', neonlight3d)
     router.get('/textpro/3dgradient', gradient3d)
     router.get('/textpro/abstragold', abstragold)
     router.get('/textpro/americanflag', americanflag)
     router.get('/textpro/spookyhallowen', spookyhallowen)
     router.get('/textpro/bagel', bagel)
     router.get('/textpro/berry', berry)
     router.get('/textpro/biscuit', biscuit)
     router.get('/textpro/blackmetal', blackmetal)
     router.get('/textpro/blackpink', blackpink)
     router.get('/textpro/greenneon', greenneon)
     router.get('/textpro/neon', neon)
     router.get('/textpro/foggy', foggy)
     router.get('/textpro/neondevil', NeonDevil)
     router.get('/textpro/christmasholiday', ChristmasHoliday)
     router.get('/textpro/engraved3d', Engraved3D)
     router.get('/textpro/space3d', Space3D)
     router.get('/textpro/minion3d', Minion3D)
     router.get('/textpro/firework', Firework)

        //Oxy
     router.get('/oxy/flamingfire', flamingfire)
     router.get('/oxy/shadow', shadow)
     router.get('/oxy/cup', cup)
     router.get('/oxy/cup2', cup2)
     router.get('/oxy/romance', romance)
     router.get('/oxy/smoke', smoke)
     router.get('/oxy/burnpaper', burnpaper)
     router.get('/oxy/lovemessage', lovemessage)
     router.get('/oxy/undergrass', undergrass)
     router.get('/oxy/love', love)
     router.get('/oxy/coffe', coffe)
     router.get('/oxy/woodheart', woodheart)
     router.get('/oxy/woodenboard', woodenboard)
     router.get('/oxy/summer3d', summer3d)
     router.get('/oxy/wolfmetal', wolfmetal)
     router.get('/oxy/nature3d', nature3d)
     router.get('/oxy/underwater', underwater)
     router.get('/oxy/goldenrose', goldenrose)
     router.get('/oxy/summernature', summernature)
     router.get('/oxy/fallleaves', fallleaves)
     router.get('/oxy/harrypotter', harrypotter)
     router.get('/oxy/carvedwood', carvedwood)
     router.get('/oxy/tiktok', tiktokoxy)
     router.get('/oxy/arcade8bit', arcade8bit)
     router.get('/oxy/battlefield4', battlefield4)
     router.get('/oxy/pubg', pubg)
     router.get('/oxy/bannergraffiti', bannergraffiti)

     //Oxy
     router.get('/ephoto/glass', glass)
